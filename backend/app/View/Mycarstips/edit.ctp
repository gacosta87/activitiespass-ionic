<section class="content-header">
  <h1>
    <?= Configure::read('namesysS'); ?>    <small><?php echo __('Mycartips'); ?></small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="<?= $this->Html->url('/Principal/')?>"><i class="fa fa-newspaper-o"></i> Inicio</a></li>
    <li class="active"><?php echo __('Mycartips'); ?></li>
  </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Edit Mycartip'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php /* ?>	<div class="actions">
		...
		<ul>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Mycartip.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Mycartip.id'))); ?></li>
