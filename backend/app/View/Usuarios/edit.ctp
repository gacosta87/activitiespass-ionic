        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Edit Usuario'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
echo $this->Form->input('clave2', array('class'=>'form-control', 'type'=>'hidden', 'value'=>$this->request->data['Usuario']['clave'])); 	
echo '</div>';	
echo '</div>';
...
echo'<div class="col-md-9">';			
echo $this->Form->input('fechaingreso', array('type'=>'date3',  'id'=>'Usuariofechaingreso', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';
	?>
							</div>
