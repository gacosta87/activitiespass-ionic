...
<section class="content">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo __('Chatpromts'); ?> Detalles</h3>
                        <hr>
                    </div><!-- /.box-header -->
                    <div class="box-body">
		...
		<dd>
			<?php echo h($chatpromt['Chatpromt']['denomincion']); ?>
			&nbsp;
		</dd>
	
						</dl>
						<p>
						    		<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $chatpromt['Chatpromt']['id'])); ?>
                            |
