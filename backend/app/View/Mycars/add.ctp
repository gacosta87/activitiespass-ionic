        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Add Mycar'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
					<?php echo $this->Form->create('Mycar', array("enctype"=>"multipart/form-data", 'class'=>'form-horizontal')); ?>
					<div class='row'>
							<div class='col-md-12'>
								<?php
...
echo'<div class="form-group">';	
echo'<label class="control-label col-md-2" for="Mycaremail">Clave</label>';		
echo'<div class="col-md-9">';			
echo $this->Form->input('clave', array('id'=>'Mycaremail', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';


echo'<div class="form-group">';	
echo'<label class="control-label col-md-2" for="Mycaremail">Rol</label>';		
echo'<div class="col-md-9">';			
echo $this->Form->input('role_id', array('id'=>'Mycaremail', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
echo '</div>';	
echo '</div>';
...
<!--------- Modulos -------->
<div class="form-group">
<label class="control-label col-md-2" for="Mycarmunicipio">Categoris</label>
<div class="col-md-9 col-sm-9 col-xs-9">
    <div class="box box-solid box-default">
        <div class="box-header with-border">
            <h3 class="box-title">Categorias</h3>
            <div class="box-tools pull-right">
                <button id="newModulosBtn" class="btn btn-box-tool" data-toggle="tooltip" title="Agregar otro servicio" data-widget="chat-pane-toggle"><i class="glyphicon glyphicon-plus"></i></button>
            </div><!-- /.box-tools -->
        </div><!-- /.box-header -->
        <div class="box-body">
            <div id="modulos-container">
                <div id="moduloscount">
                    <div class="form-group tel-con" id="modulo_0">
                        ...
                        <div class="col-md-3">
                            <select onchange="selectTagRemote('<?= $this->Html->url("/Mycars/categoriasub/0") ?>', 'servicio_0', this.value);" class="form-control tel-0" id="Modulos_0__Tipo" name="data[Afiliado][Modulos][0][tipo]" onchange="Javascript:manageExt(0);">
                        ...
                        <div class="col-md-3" id="servicio_0">
                            <select class="form-control tel-0" id="Modulos_0__Servicio" name="data[Afiliado][Modulos][0][servicio]" onchange="Javascript:manageExt(0);">
                            </select>
                        </div>
                        <div class="col-md-1">
