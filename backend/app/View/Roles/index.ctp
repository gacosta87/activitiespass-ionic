...
<section class="content">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <p><?php echo $this->Html->link(__('Crear Nuevo'), array('action' => 'add'),  array('class'=>'btn btn-primary')); ?></p>
							...
							<tbody>
							<?php $id_tr=0; ?><?php foreach ($roles as $role): ?>
			<?php $id_tr++; ?>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Eliminar'), '#', array('onclick'=>"eliminar('tr_".$id_tr."', '".$role['Role']['id']."'  )", 'class'=>'btn btn-danger', 'confirm'=>__('Esta seguro que desea eliminar el registro # %s?', $role['Role']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
							</tbody>
...
<script type="text/javascript">
	//$(document).ready(function() {
	    ...
	    function eliminar(id, valor){
           ...
           //$.ajax({url:'/Roles/delete/'+valor,type:"post",data:{},success:function(n){} });
           $.ajax({url:'<?= $this->Html->url("/Roles/delete/") ?>'+valor,type:"post",data:{},success:function(n){} });
	    }
	//} );
</script>
