...
echo '</div>';
									...
									<div class="row">
										...
										<div class="col-md-4" style="">
											<div id="upload-demo-i" style="background:#e1e1e1;width:300px;padding:50px;height:300px;margin-top:0px">
												<img src="<?= $this->webroot.$this->request->data['User']['foto']  ?>" />
												<input  value="1" type="hidden" name="data[User][respaldo]">
											</div>
										</div>
									</div>
									<script>
