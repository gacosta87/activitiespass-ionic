        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Add Usermodulo'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
echo $this->Form->input('user_id', array('id'=>'Usermodulouser_id', 'div'=>false, 'label'=>false, 'class'=>'form-control', 'empty'=>'--Seleccione--'));		
echo '</div>';	
echo '</div>';
...
echo'<div class="col-md-9">';			
echo $this->Form->input('modulo_id', array('id'=>'Usermodulomodulo_id', 'div'=>false, 'label'=>false, 'class'=>'form-control', 'empty'=>'--Seleccione--'));		
echo '</div>';	
echo '</div>';
	?>
							</div>
