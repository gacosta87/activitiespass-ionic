    ...
    <div class="box box-solid box-default">
        ...
        <div class="box-body">
            <div id="modulos-container">
                ...
                <?php $c = 0;foreach($rolesmodulos as $rolesmodulo){ ?>
                <div id="moduloscount">
                    <div class="form-group tel-con" id="modulo_<?= $c ?>">
                        <label class="control-label col-md-2">Modulos</label>
                        <div class="col-md-3">
                            <select class="form-control tel-<?= $c ?>" id="Modulos_<?= $c ?>__Tipo" name="data[Afiliado][Modulos][<?= $c ?>][tipo]" onchange="Javascript:manageExt(0);">
							<?php
	                             foreach($modulos as $modulo){
	                             	if($rolesmodulo['Rolesmodulo']['modulo_id']==$modulo['Modulo']['id']){
	                             		echo " <option value=\"".$modulo['Modulo']['id']."\" selected>".$modulo['Modulo']['denominacion']."</option>";
	                             	}else{
