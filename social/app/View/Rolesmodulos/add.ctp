        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo __('Add Roles modulos'); ?></h3>
                    <hr>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		echo $this->Form->input('role_id', array('empty'=>'--Seleccione--','id'=>'Rolesmodulorole_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
		echo '</div>';	
		echo '</div>';
		...
		echo'<div class="col-md-9">';			
		echo $this->Form->input('modulo_id', array('empty'=>'--Seleccione--','id'=>'Rolesmodulomodulo_id', 'div'=>false, 'label'=>false, 'class'=>'form-control'));		
		echo '</div>';	
		echo '</div>';*/
?>
