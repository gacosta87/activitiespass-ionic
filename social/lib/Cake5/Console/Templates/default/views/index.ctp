                ...
                <div class="box">
                    ...
                    <p><?php echo "<?php echo \$this->Html->link(__('Crear Nuevo'), array('action' => 'add'),  array('class'=>'btn btn-primary')); ?>"; ?></p>
							...
							echo "\t\t\t<tr id=\"tr_<?php echo \$id_tr; ?> \" > \n";
								...
								echo "\t\t\t<?php ";
								echo "\t\t\t \$empresa_id          = \$this->Session->read('empresa_id'); \n";
								echo "\t\t\t \$empresasurcusale_id = \$this->Session->read('empresasurcusale_id'); \n";
								echo "\t\t\t \$rol_id              = \$this->Session->read('ROL'); \n";
								echo "\t\t\t \$user_id             = \$this->Session->read('USUARIO_ID'); \n";
								echo "\t\t\t?> ";
								...
								echo "\t\t\t<?php echo \$this->Html->link(__('Eliminar'), '#', array('onclick'=>\"del('tr_\".\$id_tr.\"', '\".\${$singularVar}['{$modelClass}']['{$primaryKey}'].\"'  )\", 'class'=>'btn btn-danger', 'confirm'=>__('Esta seguro que desea eliminar el registro # %s?', \${$singularVar}['{$modelClass}']['{$primaryKey}']))); ?>\n";
								echo "\t\t</td>\n";
							echo "\t</tr>\n";
							echo "<?php endforeach; ?>\n";
							?>
