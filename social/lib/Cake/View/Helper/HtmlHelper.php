	...
	public function link($title, $url = null, $options = array(), $confirmMessage = false) {
		...
		if ($confirmMessage) {
			if(isset($options['onclick'])){
                ...
                $options['onclick'] = $this->_confirm($confirmMessage, $action, 'return false;', $options);
			}else{
...
/**
 * Function para incluir la template sin eliminarlas
 *
 */
	public function templateinclude($url, $template) {
			return $this->assetUrl("/template/".$template."/".$url);
	}
