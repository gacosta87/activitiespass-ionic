...
import { obtenerPerfilesUsuario } from './obtenerPerfilesUsuario';
...
@NgModule({
  imports: [
    ...
    PromocionviewModule,
    RouterModule.forChild([{ path: '', component: obtenerPerfilesUsuario }])
  ],
  declarations: [obtenerPerfilesUsuario]
})
export class obtenerPerfilesUsuarioModule {}
