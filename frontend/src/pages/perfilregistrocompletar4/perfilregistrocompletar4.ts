...
@Component({
  selector: 'app-perfilregistrocompletar4',
  templateUrl: 'perfilregistrocompletar4.html',
  styleUrls: ['perfilregistrocompletar4.scss'],
  providers:[Usuario, GooglePlus, Facebook, Instagram]
})

export class Perfilregistrocompletar4  implements  OnInit{
