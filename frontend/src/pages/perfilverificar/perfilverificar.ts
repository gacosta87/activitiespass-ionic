...
@Component({
  selector: 'app-perfilverificar',
  templateUrl: 'perfilverificar.html',
  styleUrls: ['perfilverificar.scss'],
  providers:[Usuario, Home, Camera, File, Crop, GooglePlus, Facebook, Instagram, Geolocation]
})

export class Perfilverificar  implements  OnInit{
  ...
  empezar(){
          ...
          if(this.datos[0]['verificacion_1']=="1"){ this.navController.navigateRoot("/perfilverificar1");

    }else if(this.datos[0]['verificacion_2']=="1"){ this.navController.navigateRoot("/perfilverificar2");

    }else if(this.datos[0]['verificacion_3']=="1"){ this.navController.navigateRoot("/perfilverificar3");

    }else if(this.datos[0]['verificacion_4']=="1"){ this.navController.navigateRoot("/perfilverificar4");

    }else if(this.datos[0]['verificacion_5']=="1"){ this.navController.navigateRoot("/perfilverificar5");
 ...
 salirdecargando(){
  ...
  ionViewDidEnter(){ 
      ...
      this.mycarid   = localStorage.getItem('MYCARID');
              this.provider.miperfil_usuario(this.mycarid, this.usuarioid).subscribe((response) => {  
