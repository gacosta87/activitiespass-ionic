...
@Component({
  selector: 'app-perfilverificar3',
  templateUrl: 'perfilverificar3.html',
  styleUrls: ['perfilverificar3.scss'],
  providers:[Usuario, GooglePlus, Facebook, Instagram, Camera, File, Crop]
})

export class Perfilverificar3  implements  OnInit{
  ...
  updatefoto() {
    const loader = this.loadingCtrl.create({
      ...
      //message: "Un momento, por favor..."
              ...
              load.present();
              this.provider_usuario.perfilverificar3(this.mycarid, this.usuarioid, this.image).subscribe((response) => {  
                          this.loadingCtrl.getTop().then(loader => {if(loader!=undefined) {this.loadingCtrl.dismiss();} 
                                  if(response['code']==200){
                                      this.navController.navigateForward('/perfilverificar4');
