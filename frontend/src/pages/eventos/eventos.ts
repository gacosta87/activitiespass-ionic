...
export class eventos  implements  OnInit, OnDestroy {
  @ViewChild("mySliderpublicidad3", { static: false }) mySliderpubli3?: IonSlides;
   ...
   public rutas   = new Variablesglobales();
    ...
    ionViewDidEnter(){ 
        ...
        this.mySliderpubli3.stopAutoplay();
        this.mySliderpubli3.startAutoplay();
  ...
  ngOnInit() {
      ...
      this.helper.recibir4.subscribe(res=>{
            if(this.dispara4!=res){
                  this.dispara4 = res;
                  this.subirarriba();
                  console.log("el disparador: "+this.dispara4);
            }
      });            
