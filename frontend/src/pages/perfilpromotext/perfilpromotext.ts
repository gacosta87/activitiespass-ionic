...
@Component({
  selector: 'app-perfilpromotext',
  templateUrl: 'perfilpromotext.html',
  styleUrls: ['perfilpromotext.scss'],
  providers:[Variablesglobales, Home] 
})
export class Perfilpromotext implements  OnInit{
    ...
    enviarformulario() {
        ...
        const loader = this.loadingCtrl.create({
          ...
          showBackdrop: true
                  ...
                  load.present();
                  this.provider.promocionestextadd(this.mycarid, 
                                                   this.usuarioid, 
