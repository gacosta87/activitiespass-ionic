...
@Component({
  selector: 'app-perfilregistrocompletar3',
  templateUrl: 'perfilregistrocompletar3.html',
  styleUrls: ['perfilregistrocompletar3.scss'],
  providers:[Usuario, GooglePlus, Facebook, Instagram]
})

export class Perfilregistrocompletar3  implements  OnInit {
 ...
 salirdecargando(){
  ...
  omitir(){
        ...
        //this.navController.navigateForward("/principal/perfil/"+cuentaperfil);
  }
  regresar(){
                          ...
                          this.loadingCtrl.getTop().then(loader => {if(loader!=undefined) {this.loadingCtrl.dismiss();} 
                                        if(response['code']==200){
                                            ...
                                            if(this.opcionnavegacion=='1'){
                                                    ...
                                                    this.navController.navigateForward('perfilregistrocompletar4/2');
                                            }
