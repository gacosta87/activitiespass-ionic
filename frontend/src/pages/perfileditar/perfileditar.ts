...
export class Perfileditar implements  OnInit{
  ...
  constructor(public navController: NavController,
    ...
    this.myForm = this.formBuilder.group({
          ...
          servicios: new FormControl('', Validators.compose([ 
          ...
          categoria_id: new FormControl('', Validators.compose([ 
                              ])
                   ),
          ...
          tiktok: new FormControl('', Validators.compose([ 
                              ])
                   ),
         ...
         fechanacimiento: new FormControl('', Validators.compose([ 
          ...
          fechanacimiento2: new FormControl('', Validators.compose([]))
      });
