...
import { Platform, NavController, LoadingController, AlertController, ModalController, PopoverController, IonContent } from '@ionic/angular';
...
@Component({
  selector: 'app-perfilinfo',
  templateUrl: 'perfilinfo.html',
  styleUrls: ['perfilinfo.scss'],
  providers:[Usuario, 
            GooglePlus, 
            Facebook, 
            Instagram, 
...
export class Perfilinfo   implements  OnInit {
  ...
  constructor(public navController: NavController,
          ...
          //private backgroundMode: BackgroundMode
                ...
                this.sessionactiva = localStorage.getItem('SESSIONACTIVA_Activitiespass_9');
  ...
  irwhatsapp(val){
       ...
       this.socialSharing.shareViaWhatsAppToReceiver(val, 'Activitiespass app').then(() => {
         // Success!
        }).catch(() => {
          // Error!
        });
  ...
  help(){
        this.socialSharing.shareViaWhatsAppToReceiver('+19787956119', 'Saludos me gustaria solicitar una ayuda sobre Activitiespass').then(() => {
         // Success!
        }).catch(() => {
          // Error!
        });
