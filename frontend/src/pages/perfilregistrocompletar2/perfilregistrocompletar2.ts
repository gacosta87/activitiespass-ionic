...
@Component({
  selector: 'app-perfilregistrocompletar2',
  templateUrl: 'perfilregistrocompletar2.html',
  styleUrls: ['perfilregistrocompletar2.scss'],
  providers:[Usuario, GooglePlus, Facebook, Instagram, Camera, File, Crop, ]
})

export class Perfilregistrocompletar2  implements  OnInit{
                          ...
                          this.loadingCtrl.getTop().then(loader => {if(loader!=undefined) {this.loadingCtrl.dismiss();} 
                                  if(response['code']==200){
                                            ...
                                            if(this.opcionnavegacion=='1'){
                                                    ...
                                                    this.navController.navigateForward('perfilregistrocompletar3/2');
                                            }
