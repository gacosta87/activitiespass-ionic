...
@Component({
  selector: 'app-perfilverificar1',
  templateUrl: 'perfilverificar1.html',
  styleUrls: ['perfilverificar1.scss'],
  providers:[Usuario, GooglePlus, Facebook, Instagram]
})

export class Perfilverificar1  implements  OnInit {
  ...
  constructor(public navController: NavController,
          ...
          private platform: Platform,
                ...
                this.myForm = this.formBuilder.group({
                      pais_id: new FormControl('1', Validators.compose([ 
                                              Validators.required
                                          ])
                               ),
                  });
  ...
  enviarformulario(){
    const loader = this.loadingCtrl.create({
      ...
      //message: "Un momento, por favor..."
              ...
              load.present();
              this.provider_usuario.perfilverificar1(this.usuarioid, this.myForm.value).subscribe((response) => {  
                          this.loadingCtrl.getTop().then(loader => {if(loader!=undefined) {this.loadingCtrl.dismiss();} 
                                        if(response['code']==200){
                                                    this.navController.navigateForward('/perfilverificar2');
