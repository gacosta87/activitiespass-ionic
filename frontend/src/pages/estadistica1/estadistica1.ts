...
@Component({
  ...
  templateUrl: 'estadistica1.html',
  styleUrls: ['estadistica1.scss'],
  providers:[Usuario, Home, Camera, File, Crop, GooglePlus, Facebook, Instagram, Geolocation]
})

export class Estadistica1 implements  OnInit{
      ...
      this.mycarid   = localStorage.getItem('MYCARID');
       const loader = this.loadingCtrl.create({
          ...
          //message: "Un momento, por favor..."
                  ...
                  load.present();
                  this.provider.miperfilsmall(this.mycarid, this.usuarioid, 1).subscribe((response) => {  
                              this.loadingCtrl.getTop().then(loader => {if(loader!=undefined) {this.loadingCtrl.dismiss();} 
  ...
  link(var1, var2, var3, var4) {
      localStorage.setItem('NAMEESTADISTICA', var3+ ' '+var4);
      this.navController.navigateForward("estadistica2/"+var1+"/"+var2);
  }//FIN FUNCTION
}//FIN CLASS
